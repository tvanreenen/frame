...
Start JankyBorders using launchd or your preferred startup manager.
...
exec-on-workspace-change = ['/bin/bash', '-c',
    'sketchybar --trigger aerospace_workspace_change FOCUSED_WORKSPACE=$SIMPLEWM_FOCUSED_WORKSPACE'
]
----
...
Use macOS native keyboard shortcuts for screenshots.
