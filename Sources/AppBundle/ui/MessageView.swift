...
public func getMessageWindow(messageModel: MessageModel) -> some Scene {
    ...
    SwiftUI.Window(messageModel.message?.title ?? simpleWmAppName, id: messageWindowId) {
...
public let messageWindowId = "\(simpleWmAppName).messageView"
...
public struct Message: Hashable, Equatable {
    ...
    init(type: MessageType = .config, title: String = simpleWmAppName, description: String, body: String) {
        self.type = type
        self.title = title
