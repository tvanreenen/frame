...
package enum Json: Encodable, Equatable {
    ...
    package static func newOrDie(_ value: Any?) -> Json {
    ...
    package static func stringOrNull(_ str: String?) -> Json { str.map(Json.string) ?? .null }
    ...
    package var asDictOrDie: [String: Json] {
